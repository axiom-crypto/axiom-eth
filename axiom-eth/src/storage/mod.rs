use crate::{
    ...
    block_header::{
        assign_vec, get_block_header_rlp_max_lens, EthBlockHeaderChip, EthBlockHeaderTrace,
        EthBlockHeaderTraceWitness, GOERLI_BLOCK_HEADER_RLP_MAX_BYTES,
    ...
    mpt::{AssignedBytes, MPTInput, MPTProof, MPTProofWitness},
    rlp::{
...
pub trait EthStorageChip<F: Field> {
    ...
    fn parse_account_proofs_phase0(
        ...
        keccak: &mut KeccakChip<F>,
        addr_proofs: Vec<(AssignedBytes<F>, MPTProof<F>)>,
    ...
    fn parse_storage_proofs_phase0(
        ...
        thread_pool: &mut GateThreadBuilder<F>,
        keccak: &mut KeccakChip<F>,
        slot_proofs: Vec<(AssignedBytes<F>, MPTProof<F>)>,
